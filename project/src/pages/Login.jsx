      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400 font-arabic">
            أو <Link to="/register" className="text-primary-600 hover:text-primary-500">إنشاء حساب جديد</Link>
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="remember-me" className="mr-2 rtl:ml-2 rtl:mr-0 block text-sm text-gray-700 dark:text-gray-300 font-arabic">
                  تذكرني
                </label>
              </div>

              <div className="text-sm">
                <Link to="/forgot-password" className="text-primary-600 hover:text-primary-500 font-arabic">
                  نسيت كلمة المرور؟
                </Link>
              </div>
            </div>
